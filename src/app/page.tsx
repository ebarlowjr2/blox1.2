        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <Link href="/signin?redirect=/dashboard" className="rounded-lg bg-gradient-to-r from-cyan-600 to-emerald-600 px-3.5 py-2.5 text-sm font-semibold shadow-lg shadow-cyan-600/25 ring-1 ring-white/10 hover:from-cyan-500 hover:to-emerald-500">Login</Link>
            </div>
          </div>
        </div>
      </header>
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <div>
              ...
              <div className="mt-7 flex flex-wrap items-center gap-3">
                <Link href="/signin?redirect=/dashboard" className="rounded-xl bg-gradient-to-r from-cyan-600 to-emerald-600 px-5 py-3 text-sm font-semibold shadow-lg shadow-cyan-600/30 ring-1 ring-white/10 hover:from-cyan-500 hover:to-emerald-500">Login</Link>
      ...
      <section id="agents" className="relative">
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
          <div className="mb-8 flex items-end justify-between gap-6">
            ...
            <Link href="/signin?redirect=/dashboard" className="hidden rounded-lg border border-white/15 px-3 py-2 text-sm text-white/90 hover:bg-white/5 md:inline-block">Login</Link>
          </div>
          ...
          <div className="grid items-center gap-10 lg:grid-cols-2">
            <div>
              ...
              <div className="mt-6 flex flex-wrap items-center gap-3">
                <Link href="/signin?redirect=/dashboard" className="rounded-xl bg-gradient-to-r from-cyan-600 to-emerald-600 px-5 py-3 text-sm font-semibold shadow-lg shadow-cyan-600/30 ring-1 ring-white/10 hover:from-cyan-500 hover:to-emerald-500">Connect my tools</Link>
